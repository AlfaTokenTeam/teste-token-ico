...
import "./TesteToken.sol";

contract TesteTokenPreSale {
    TesteToken public token;
    address public beneficiary;
    uint public amountRaised;
    uint public bonus;

    uint constant public price = 1000000;
    uint constant public minSaleAmount = 5000000000;

    function TesteTokenPreSale(
        TesteToken _token,
        address _beneficiary,
        uint _bonus
    ) {
        token = TesteToken(_token);
